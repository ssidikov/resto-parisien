        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-charcoal-300 mb-6 leading-relaxed">
              ...
              où tradition française et innovation contemporaine se rencontrent.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+33142869145" className="text-charcoal-300 hover:text-white transition-colors">
                  +33 1 42 86 91 45
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-primary-400 flex-shrink-0" />
                <a href="mailto:contact@lemoderne.fr" className="text-charcoal-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="/menu" className="block text-charcoal-300 hover:text-white transition-colors">
                Notre Carte
              </a>
              <a href="/contact" className="block text-charcoal-300 hover:text-white transition-colors">
                Réservations
              </a>
              <a href="tel:+33142869145" className="block text-primary-400 hover:text-primary-300 transition-colors font-medium">
                Réserver maintenant
              </a>
            </div>
          </div>
