          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal-700 mb-6 leading-relaxed">
                Depuis 2018, Le Moderne redéfinit l'expérience culinaire parisienne en mariant 
                avec audace les traditions françaises et les innovations contemporaines.
              </p>
              <p className="text-lg text-charcoal-700 mb-8 leading-relaxed">
                Notre chef étoilé transforme chaque plat en œuvre d'art, utilisant exclusivement 
                des produits de saison sélectionnés auprès de producteurs locaux.
              </p>
              <a 
                href="/menu" 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-playfair font-semibold text-charcoal-900 mb-2">Horaires</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-playfair font-semibold text-charcoal-900 mb-2">Adresse</h3>
              <p className="text-charcoal-600">
                45 Rue de Rivoli<br />
                75001 Paris<br />
                Métro: Châtelet
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-playfair font-semibold text-charcoal-900 mb-2">Réservation</h3>
              <p className="text-charcoal-600">
                +33 1 42 86 91 45<br />
                contact@lemoderne.fr<br />
