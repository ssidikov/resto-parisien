...
export const metadata: Metadata = {
  title: 'Notre Carte',
  description:
    'Découvrez la carte gastronomique du restaurant Le Moderne à Paris. Cuisine française contemporaine avec des produits de saison et locaux.',
  openGraph: {
    title: 'Notre Carte | Le Moderne',
    description: 'Cuisine française contemporaine avec des produits de saison',
  },
}
  ...
  entrees: [
    {
      ...
      description:
        "Noix de Saint-Jacques bretonnes, émulsion citron vert, caviar d'Aquitaine, micro-pousses",
      price: '28',
      isSignature: true,
    },
    {
      ...
      description:
        'Foie gras du Périgord, compotée de figues violettes, pain brioché toasté, fleur de sel',
      price: '32',
    },
    {
      name: 'Velouté de Châtaigne Truffe',
      description:
        "Crème de châtaignes des Cévennes, copeaux de truffe noire, chantilly à l'huile de noisette",
      price: '24',
    },
    {
      name: 'Carpaccio de Bœuf aux Herbes',
      description:
        'Filet de bœuf Black Angus, roquette sauvage, copeaux de parmesan 36 mois, vinaigrette balsamique',
      price: '26',
    },
  ],
  plats: [
    {
      ...
      description:
        "Homard de Bretagne grillé, beurre blanc à l'estragon, légumes de saison, risotto crémeux",
      price: '58',
      isSignature: true,
    },
    {
      ...
      description:
        'Bœuf de race Salers, jus corsé au vin de Cahors, écrasée de pommes de terre à la truffe',
      price: '45',
    },
    {
      name: 'Turbot Sauvage en Croûte',
      description:
        'Filet de turbot sauvage, croûte aux herbes fraîches, beurre blanc au champagne, légumes croquants',
      price: '42',
    },
    {
      name: 'Magret de Canard Laqué',
      description:
        'Magret des Landes laqué au miel et épices, purée de panais, jus réduit aux cerises griottes',
      price: '38',
    },
    {
      name: 'Agneau de Lozère Rosé',
      description:
        "Carré d'agneau rosé, tian de légumes provençaux, jus d'agneau aux herbes de Provence",
      price: '44',
    },
  ],
  desserts: [
    ...
    },
    {
      ...
      description:
        'Pâte sablée, poires pochées au vin rouge, glace cannelle, coulis de caramel beurre salé',
      price: '16',
    },
    {
      ...
      <div className='max-w-6xl mx-auto px-4 py-16'>
        ...
        <section className='mb-16'>
          <div className='text-center mb-12'>
            <h2 className='text-4xl font-playfair font-bold text-charcoal-900 mb-4'>Entrées</h2>
        ...
        <section className='mb-16'>
          <div className='text-center mb-12'>
            <h2 className='text-4xl font-playfair font-bold text-charcoal-900 mb-4'>Desserts</h2>
            <div className='w-24 h-1 bg-gradient-to-r from-primary-400 to-gold mx-auto mb-6'></div>
            <p className='text-lg text-charcoal-600 max-w-2xl mx-auto'>
        ...
        <section className='bg-primary-50 rounded-2xl p-8 text-center'>
          ...
          <p className='text-charcoal-700 mb-6 max-w-2xl mx-auto'>
            Laissez-vous guider par notre chef à travers un parcours gastronomique d'exception. Menu
            7 services avec accords mets et vins disponible sur demande.
          </p>
